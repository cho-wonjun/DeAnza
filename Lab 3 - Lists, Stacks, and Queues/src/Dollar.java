 ...
 * Lab 2 Team 12
 * @author Won Jun Cho
 * This class is designed for Dollar which inherits from Currency class to build a currency simulator using classes,inheritance and polymorphism.
 */
public class Dollar extends Currency {
     ...
     *
     * This method checks for equality between the given input currency value and the current value.
     ...
     *
     * This method compares the given input currency value to the current value of the same type for greater value between them.
     * Pre: currency - input currency value to be compared to the current value.
     * Post:
    ...
    public boolean isGreater(Currency currency) {
        try{
            if(isSameType(currency)){
                ...
                throw new Exception("Invalid greater comparison");
            }
        }catch (Exception e){
            System.out.println(e.getMessage());
        }
     ...
     * Algorithm toString()
     *
     * This method returns Dollar representation of the Currency object.
     * Pre:
     * Post:
     * Return: "$" + getWholePart() + "." + getFractionalPart() or "$" + getWholePart() + ".0" + getFractionalPart()
     */

    /*
     * if (fractional part is less than 10) {
     *      return formatted string representation of the object
     * } else {
     *      return formatted string representation of the object in different format
     * }
     */
    public String toString() {
        if (this.getFractionalPart() < 10) {
            return "$" + this.getWholePart() + ".0" + this.getFractionalPart();
        } else {
            return "$" + this.getWholePart() + "." + this.getFractionalPart();
        }
    }
